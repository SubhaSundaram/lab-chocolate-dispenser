...
//console.log(removeChocolates(10, chocolates))
...
//Progression 4: Dispense ___ chocolates of ____ colordispenseChocolatesOfColor(chocolates, 5, 'blue')
//console.log(dispenseChocolatesOfColor(chocolates, 0, 'blue'))
function dispenseChocolatesOfColor(chocolates, number, color) {
  ...
  if (number > chocolates.length)
    ...
    //to dispense number of chocolates with the required color
    let colorchoc = chocolates.filter((x) => x == color)
    for (let i = 0; i < number; i++) {
      let arr = colorchoc.pop()
      result.push(arr)
    }
    return result
  }
...
//let candies = ['red', 'blue', 'blue', 'crimson']
//console.log(noOfChocolates(candies))
...
//     let flatarr = resultArray.flat()
//     if (!flatarr.includes(candy)) {
//       let res = candies.filter((x) => x == candy)
//       resultArray.push(res)
//     }
//   })
//   let sortedArray = resultArray.sort((a, b) => {
...
// let candies = ['red', 'green', 'crimson', 'silver', 'crimson', 'red']'red', 'green', 'crimson', 'silver', 'green', 'red
// console.log(
console.log(changeChocolateColorAllOfxCount(['red'], 'red', 'red'))
